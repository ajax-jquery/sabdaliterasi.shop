...
var pfMod = window.pfMod || (function(window, undef) {
  ...
  var pf = {
    ...
    setVariables: function() {
      ...
      var pfAppCSS = this.config.disableUI ? '' : "//cdn.printfriendly.com/assets/pf-app/main-c93070859c8f598f1f8430dcc72476b504673003b1bde12723daf6dc140e653c.css";
      ...
      var js = {
        ...
        core: "//cdn.printfriendly.com/assets/client/core-b846689268673e7e31264d5c7c5c573ac3f549fd0cadc4f7a50715e528759ab1.js",
        algo: "//cdn.printfriendly.com/assets/client/algo-43913e3d50e87aad4efaefb3e67c345ce169f8a13f33a960b394acf1a5788f65.js"
      };
    ...
    loadCore: function() {
      ...
      if (this.config.isExtension) {
        ...
        coreIframe.src = "//cdn.printfriendly.com/assets/client/core-18f0e7ff530dce86c2d174d546c080183111e26d2efab8ddcb7fe044c313514b.html"
      }
    },
  ...
  var pfDataHelper = {
    ...
    get: function() {
      ...
      page = {
        ...
        body: this.replaceShadowRootElements(document.getElementById('PRINT')).innerHTML.replace(/<\s*?embed[^>]*?>(.*?<\s*?\/\s*?embed\s*?>)?/g, ''),
