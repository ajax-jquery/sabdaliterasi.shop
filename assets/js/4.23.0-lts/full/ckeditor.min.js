...
"\x26lt;")},htmlDecode:function(a){return a.replace(l,f)},htmlEncodeAttr:function(a){return CKEDITOR.tools.htmlEncode(a).replace(k,"\x26quot;")},htmlDecodeAttr:function(a){return CKEDITOR.tools.htmlDecode(a)},transformPlainTextToHtml:function(a,b){var c=b==CKEDITOR.ENTER_BR,f=this.htmlEncode(a.replace(/\r\n/g,"\n")),f=f.replace(/\t/g,"\x26nbsp;\x26nbsp; \x26nbsp;"),k=b==CKEDITOR.ENTER_P?"p":"div";if(!c){var m=/\n{2}/g;if(m.test(f))var l="\x3c"+k+"\x3e",e="\x3c/"+k+"\x3e",f=l+f.replace(m,function(){return e+
...
(m.push(k?"⇧":a[16]),l.push(a[16]));f&&(a[f]?(m.push(a[f]),l.push(a[f])):(m.push(String.fromCharCode(f)),l.push(String.fromCharCode(f))));return{display:m,aria:l}},transparentImageData:"data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",getCookie:function(a){a=a.toLowerCase();for(var b=document.cookie.split(";"),c,f,k=0;k<b.length;k++)if(c=b[k].split("\x3d"),f=decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()),f===a)return decodeURIComponent(1<c.length?
...
entries:function(a){return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a),function(b){return[b,a[b]]})},values:function(a){return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a),function(b){return a[b]})},keys:function(a){var b=Object.prototype.hasOwnProperty,c=[],f=CKEDITOR.tools.object.DONT_ENUMS;if(CKEDITOR.env.ie&&9>CKEDITOR.env.version&&(!a||"object"!==typeof a)){b=[];if("string"===typeof a)for(c=0;c<a.length;c++)b.push(String(c));return b}for(var k in a)c.push(k);if(CKEDITOR.env.ie&&
...
a["border-"+f+"-"+l];k[l]=e?e:c[l]&&c[l][f]}b["border-"+f]=new CKEDITOR.tools.style.border(k);return b},{})}}});CKEDITOR.tools.array.indexOf=CKEDITOR.tools.indexOf;CKEDITOR.tools.array.isArray=CKEDITOR.tools.isArray;CKEDITOR.MOUSE_BUTTON_LEFT=0;CKEDITOR.MOUSE_BUTTON_MIDDLE=1;CKEDITOR.MOUSE_BUTTON_RIGHT=2})();
...
CKEDITOR.env.webkit&&(d=this.getEditor(!1))&&(d._.previousScrollTop=null);d=a.getWindow();e=r(this,d);var v=r(a,d),J=this.$.offsetHeight;f=this.$.offsetWidth;var G=a.$.clientHeight,p=a.$.clientWidth;d=e.x-m(this,"left")-v.x||0;g=e.y-m(this,"top")-v.y||0;f=e.x+f+m(this,"right")-(v.x+p)||0;e=e.y+J+m(this,"bottom")-(v.y+G)||0;(0>g||0<e)&&h(0,!0===b?g:!1===b?e:0>g?g:e);c&&(0>d||0<f)&&h(0>d?d:f,0)},setState:function(a,b,c){b=b||"cke";switch(a){case CKEDITOR.TRISTATE_ON:this.addClass(b+"_on");this.removeClass(b+
...
b){var c=this.startContainer,e=this.startOffset,d=this.collapsed;if((!a||d)&&c&&c.type==CKEDITOR.NODE_TEXT){if(e)if(e>=c.getLength())e=c.getIndex()+1,c=c.getParent();else{var g=c.split(e),e=c.getIndex()+1,c=c.getParent();this.startContainer.equals(this.endContainer)?this.setEnd(g,this.endOffset-this.startOffset):c.equals(this.endContainer)&&(this.endOffset+=1)}else e=c.getIndex(),c=c.getParent();this.setStart(c,e);if(d){this.collapse(!0);return}}c=this.endContainer;e=this.endOffset;b||d||!c||c.type!=
...
this.root);c=this.clone();c.collapse(!0);c.setStartAt(a.block||a.blockLimit,CKEDITOR.POSITION_AFTER_START);a=new CKEDITOR.dom.walker(c);a.evaluator=b();return a.checkBackward()},checkEndOfBlock:function(a){var c=this.endContainer,e=this.endOffset;CKEDITOR.env.ie&&c.type==CKEDITOR.NODE_TEXT&&(c=CKEDITOR.tools.rtrim(c.substring(e)),k.test(c)&&this.trim(1,0));a||this.trim();a=new CKEDITOR.dom.elementPath(this.endContainer,this.root);c=this.clone();c.collapse(!1);c.setEndAt(a.block||a.blockLimit,CKEDITOR.POSITION_BEFORE_END);
...
e.endNode.equals(c),h&&k&&d.push(c);return d}};CKEDITOR.dom.range.mergeRanges=function(a){return CKEDITOR.tools.array.reduce(a,function(a,b){var c=a[a.length-1],e=!1;b=b.clone();b.enlarge(CKEDITOR.ENLARGE_ELEMENT);if(c){var d=new CKEDITOR.dom.range(b.root),e=new CKEDITOR.dom.walker(d),f=CKEDITOR.dom.walker.whitespaces();d.setStart(c.endContainer,c.endOffset);d.setEnd(b.startContainer,b.startOffset);for(d=e.next();f(d)||b.endContainer.equals(d);)d=e.next();e=!d}e?c.setEnd(b.endContainer,b.endOffset):
...
a.name||t.$block[a.name])}function G(a,b,c){var e=a.name;if(t.$empty[e]||!a.children.length)"hr"==e&&"br"==b?a.replaceWith(v()):(a.parent&&c.push({check:"it",el:a.parent}),a.remove());else if(t.$block[e]||"tr"==e)if("br"==b)a.previous&&!J(a.previous)&&(b=v(),b.insertBefore(a)),a.next&&!J(a.next)&&(b=v(),b.insertAfter(a)),a.replaceWithChildren();else{var e=a.children,d;b:{d=t[b];for(var g=0,f=e.length,n;g<f;++g)if(n=e[g],n.type==CKEDITOR.NODE_ELEMENT&&!d[n.name]){d=!1;break b}d=!0}if(d)a.name=b,a.attributes=
...
0;e<h.length;++e)p(this,d,h[e]);r(d)}y(this,n,t,{doFilter:!0,doTransform:!1!==b,skipRequired:!c,skipFinalValidation:!c});0<t.length?c=!1:((b=d.attributes["class"])&&(d.attributes["class"]=d.attributes["class"].split(" ").sort().join(" ")),c=CKEDITOR.tools.objectCompare(d.attributes,n.attributes,!0),b&&(d.attributes["class"]=b));"string"==typeof a&&(this._.cachedChecks[g]=c);return c},getAllowedEnterMode:function(){var a=["p","div","br"],b={p:CKEDITOR.ENTER_P,div:CKEDITOR.ENTER_DIV,br:CKEDITOR.ENTER_BR};
...
this.element=g;this.elementMode=f;this.name=this.elementMode!=CKEDITOR.ELEMENT_MODE_APPENDTO&&(g.getId()||g.getNameAtt())}else this.elementMode=CKEDITOR.ELEMENT_MODE_NONE;this._={};this.commands={};this.templates={};this.name=this.name||d();this.id=CKEDITOR.tools.getNextId();this.status="unloaded";this.config=CKEDITOR.tools.prototypedCopy(CKEDITOR.config);this.ui=new CKEDITOR.ui(this);this.focusManager=new CKEDITOR.focusManager(this);this.keystrokeHandler=new CKEDITOR.keystrokeHandler(this);this.on("readOnly",
...
h.langEntries[d[f]]);if(h[b[g]])h[b[g]](a)}a.fireOnce("pluginsLoaded");c.keystrokes&&a.setKeystroke(a.config.keystrokes);for(f=0;f<a.config.blockedKeystrokes.length;f++)a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[f]]=1;a.status="loaded";a.fireOnce("loaded");CKEDITOR.fire("instanceLoaded",null,a)}})})}function B(){var a=this.element;if(a&&this.elementMode!=CKEDITOR.ELEMENT_MODE_APPENDTO){var b=this.getData();this.config.htmlEncodeOutput&&(b=CKEDITOR.tools.htmlEncode(b));a.is("textarea")?
...
!b.isOrphan||b.type==CKEDITOR.NODE_TEXT}}function y(a,b){return a in CKEDITOR.dtd.$listItem||a in CKEDITOR.dtd.$tableContent?a==b||"dt"==a&&"dd"==b||"dd"==a&&"dt"==b:!1}var F=new CKEDITOR.htmlParser,r=h instanceof CKEDITOR.htmlParser.element?h:"string"==typeof h?new CKEDITOR.htmlParser.element(h):new CKEDITOR.htmlParser.fragment,m=[],L=[],v=r,J="textarea"==r.name,G="pre"==r.name;F.onTagOpen=function(e,g,f,h){g=new CKEDITOR.htmlParser.element(e,g);g.isUnknown&&f&&(g.isEmpty=!0);g.isOptionalClose=h;
...
b&&this.type!=b))var d=a(this);if(!1!==d){c=this.children;for(var g=0;g<c.length;g++)d=c[g],d.type==CKEDITOR.NODE_ELEMENT?d.forEach(a,b):b&&d.type!=b||a(d)}},getFilterContext:function(a){return a||{}}};CKEDITOR.config.shiftLineBreaks=!0})();"use strict";
...
(function(){function a(a,d){function f(a){return a||CKEDITOR.env.needsNbspFiller?new CKEDITOR.htmlParser.text(" "):new CKEDITOR.htmlParser.element("br",{"data-cke-bogus":1})}function t(a,d){return function(g){if(g.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var n=[],t=b(g),h,C;if(t)for(x(t,1)&&n.push(t);t;)e(t)&&(h=c(t))&&x(h)&&((C=c(h))&&!e(C)?n.push(h):(f(k).insertAfter(h),h.remove())),t=t.previous;for(t=0;t<n.length;t++)n[t].remove();if(n=!a||!1!==("function"==typeof d?d(g):d))k||CKEDITOR.env.needsBrFiller||
g.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT?k||CKEDITOR.env.needsBrFiller||!(7<document.documentMode||g.name in CKEDITOR.dtd.tr||g.name in CKEDITOR.dtd.$listItem)?(n=b(g),n=!n||"form"==g.name&&"input"==n.name):n=!1:n=!1;n&&g.add(f(a))}}}function x(a,b){if((!k||CKEDITOR.env.needsBrFiller)&&a.type==CKEDITOR.NODE_ELEMENT&&"br"==a.name&&!a.attributes["data-cke-eol"])return!0;var c;return a.type==CKEDITOR.NODE_TEXT&&(c=a.value.match(L))&&(c.index&&((new CKEDITOR.htmlParser.text(a.value.substring(0,c.index))).insertBefore(a),
a.value=c[0]),!CKEDITOR.env.needsBrFiller&&k&&(!b||a.parent.name in D)||!k&&((c=a.previous)&&"br"==c.name||!c||e(c)))?!0:!1}var C={elements:{}},k="html"==d,D=CKEDITOR.tools.extend({},p),E;for(E in D)"#"in J[E]||delete D[E];for(E in D)C.elements[E]=t(k,a.config.fillEmptyBlocks);C.root=t(k,!1);C.elements.br=function(a){return function(b){if(b.parent.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var d=b.attributes;if("data-cke-bogus"in d||"data-cke-eol"in d)delete d["data-cke-bogus"];else{for(d=b.next;d&&g(d);)d=
...
(function(){CKEDITOR.inline=function(a,d){a=CKEDITOR.editor._getEditorElement(a);if(!a)return null;if(CKEDITOR.editor.shouldDelayEditorCreation(a,d))return CKEDITOR.editor.initializeDelayedEditorCreation(a,d,"inline");var b=a.is("textarea")?a:null,c=b?b.getValue():a.getHtml(),g=new CKEDITOR.editor(d,a,CKEDITOR.ELEMENT_MODE_INLINE);b?(g.setData(c,null,!0),a=CKEDITOR.dom.element.createFromHtml('\x3cdiv contenteditable\x3d"'+!!g.readOnly+'" class\x3d"cke_textarea_inline"\x3e'+b.getValue()+"\x3c/div\x3e",
...
!f.checkForward()||e.checkStartOfBlock()&&e.checkEndOfBlock())&&(b=h.fixBlock(!0,b.activeEnterMode==CKEDITOR.ENTER_DIV?"div":"p"),CKEDITOR.env.needsBrFiller||(b=b.getFirst(c))&&b.type==CKEDITOR.NODE_TEXT&&CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/)&&b.remove(),k=1,a.cancel());k&&h.select()}function d(a,b){if(a.isFake)return 0;var d=b.block||b.blockLimit,e=d&&d.getLast(c);if(!(!d||!d.isBlockBoundary()||e&&e.type==CKEDITOR.NODE_ELEMENT&&e.isBlockBoundary()||d.is("pre")||d.getBogus()))return d}
...
w.getChildCount()&&a(P=w.getFirst())&&P.is(H)&&!P.hasAttribute("contenteditable")){J=P.getElementsByTag("*");x=0;for(y=J.count();x<y;x++)if(p=J.getItem(x),!p.is(M))break a;P.moveChildren(P.getParent(1));P.remove()}}A.dataWrapper=w;x=Q}if(x){P=A.range;x=P.document;w=A.blockLimit;y=0;var G,J=[],ca,O;Q=S=0;var U,p=P.startContainer;K=A.endPath.elements[0];var R,r=K.getPosition(p),B=!!K.getCommonAncestor(p)&&r!=CKEDITOR.POSITION_IDENTICAL&&!(r&CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED),
p=b(A.dataWrapper,A);for(A.editor.enterMode!==CKEDITOR.ENTER_BR&&k(p,P);y<p.length;y++){r=p[y];if(u=r.isLineBreak)u=P,v=w,W=F=void 0,r.hasBlockSibling?u=1:(F=u.startContainer.getAscendant(m.$block,1))&&F.is({div:1,p:1})?(W=F.getPosition(v),W==CKEDITOR.POSITION_IDENTICAL||W==CKEDITOR.POSITION_CONTAINS?u=0:(v=u.splitElement(F),u.moveToPosition(v,CKEDITOR.POSITION_AFTER_START),u=1)):u=0;if(u)Q=0<y;else{u=P.startPath();!r.isBlock&&l(A.editor,u.block,u.blockLimit)&&(O=q(A.editor))&&(O=x.createElement(O),
O.appendBogus(),P.insertNode(O),CKEDITOR.env.needsBrFiller&&(G=O.getBogus())&&G.remove(),P.moveToPosition(O,CKEDITOR.POSITION_BEFORE_END));if((u=P.startPath().block)&&!u.equals(ca)){if(G=u.getBogus())G.remove(),J.push(u);ca=u}r.firstNotAllowed&&(S=1);if(S&&r.isElement){u=P.startContainer;for(v=null;u&&!m[u.getName()][r.name];){if(u.equals(w)){u=null;break}v=u;u=u.getParent()}if(u)v&&(U=P.splitElement(v),A.zombies.push(U),A.zombies.push(v));else{v=w.getName();R=!y;u=y==p.length-1;v=d(r.node,v);F=[];
W=v.length;for(var Z=0,Y=void 0,da=0,fa=-1;Z<W;Z++)Y=v[Z]," "==Y?(da||R&&!Z||(F.push(new CKEDITOR.dom.text(" ")),fa=F.length),da=1):(F.push(Y),da=0);u&&fa==F.length&&F.pop();R=F}}if(R){for(;u=R.pop();)P.insertNode(u);R=0}else P.insertNode(r.node);r.lastNotAllowed&&y<p.length-1&&((U=B?K:U)&&P.setEndAt(U,CKEDITOR.POSITION_AFTER_START),S=0);P.collapse()}}1!=p.length?G=!1:(G=p[0],G=G.isElement&&"false"==G.node.getAttribute("contenteditable"));G&&(Q=!0,u=p[0].node,P.setStartAt(u,CKEDITOR.POSITION_BEFORE_START),
P.setEndAt(u,CKEDITOR.POSITION_AFTER_END));A.dontMoveCaret=Q;A.bogusNeededBlocks=J}G=A.range;var ba;R=A.bogusNeededBlocks;for(ca=G.createBookmark();O=A.zombies.pop();)O.getParent()&&(U=G.clone(),U.moveToElementEditStart(O),U.removeEmptyBlocksAtEnd());if(R)for(;O=R.pop();)CKEDITOR.env.needsBrFiller?O.appendBogus():O.append(G.document.createText(" "));for(;O=A.mergeCandidates.pop();)O.mergeSiblings();CKEDITOR.env.webkit&&G.startPath()&&(O=G.startPath(),O.block?O.block.$.normalize():O.blockLimit&&O.blockLimit.$.normalize());
...
c),f=f.block,g=g.block;f&&g&&!f.equals(g)&&b(g,d,e);d.remove();e.remove()}}},table:function(){function a(c){var e=[],f,g=new CKEDITOR.dom.walker(c),h=c.startPath().contains(d),k=c.endPath().contains(d),t={};g.guard=function(a,g){if(a.type==CKEDITOR.NODE_ELEMENT){var H="visited_"+(g?"out":"in");if(a.getCustomData(H))return;CKEDITOR.dom.element.setMarker(t,a,H,1)}if(g&&h&&a.equals(h))f=c.clone(),f.setEndAt(h,CKEDITOR.POSITION_BEFORE_END),e.push(f);else if(!g&&k&&a.equals(k))f=c.clone(),f.setStartAt(k,
CKEDITOR.POSITION_AFTER_START),e.push(f);else{if(H=!g)H=a.type==CKEDITOR.NODE_ELEMENT&&a.is(d)&&(!h||b(a,h))&&(!k||b(a,k));if(!H&&(H=g))if(a.is(d))var H=h&&h.getAscendant("table",!0),D=k&&k.getAscendant("table",!0),l=a.getAscendant("table",!0),H=H&&H.contains(l)||D&&D.contains(l);else H=void 0;H&&(f=c.clone(),f.selectNodeContents(a),e.push(f))}};g.lastForward();CKEDITOR.dom.element.clearAllMarkers(t);return e}function b(a,c){var d=CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED,e=a.getPosition(c);
...
"focusout":"blur",function(){var a=p&&(p.isFake||2>p.getRanges().length);CKEDITOR.env.gecko&&!q&&a||(c.lockSelection(p),D=1)},null,null,-1),n.attachListener(n,"mousedown",function(){D=0});if(CKEDITOR.env.ie&&!q){var r;n.attachListener(n,"mousedown",function(a){2==a.data.$.button&&((a=c.document.getSelection())&&a.getType()!=CKEDITOR.SELECTION_NONE||(r=c.window.getScrollPosition()))});n.attachListener(n,"mouseup",function(a){2==a.data.$.button&&r&&(c.document.$.documentElement.scrollLeft=r.x,c.document.$.documentElement.scrollTop=
...
new CKEDITOR.dom.node(e.commonAncestorContainer);else{try{e=a.createRange()}catch(f){}d=e&&CKEDITOR.dom.element.get(e.item&&e.item(0)||e.parentElement())}if(!d||d.type!=CKEDITOR.NODE_ELEMENT&&d.type!=CKEDITOR.NODE_TEXT||!this.root.equals(d)&&!this.root.contains(d))this._.cache.type=CKEDITOR.SELECTION_NONE,this._.cache.startElement=null,this._.cache.selectedElement=null,this._.cache.selectedText="",this._.cache.ranges=new CKEDITOR.dom.rangeList;return this};var z={img:1,hr:1,li:1,table:1,tr:1,td:1,
...
c.startOffset&&z[d.childNodes[c.startOffset].nodeName.toLowerCase()]&&(b=CKEDITOR.SELECTION_ELEMENT)}return a.type=b},getRanges:function(){var a=m?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var e=d.children,f,g,h=b.duplicate(),k=0,l=e.length-1,t=-1,q,m;k<=l;)if(t=Math.floor((k+l)/2),f=e[t],h.moveToElementText(f),q=h.compareEndPoints("StartToStart",
...
q?"StartToStart":"EndToStart",b);h=h.text.replace(/(\r\n|\r)/g,"\n").length;if(!h)return{container:d,offset:a(f)+(0<q?0:1)};for(;0<h;)try{g=f[0<q?"previousSibling":"nextSibling"],g.nodeType==CKEDITOR.NODE_TEXT&&(h-=g.nodeValue.length,m=g),f=g}catch(w){return{container:d,offset:a(f)}}return{container:m,offset:0<q?-h:m.nodeValue.length+h}};return function(){var a=this.getNative(),c=a&&a.createRange(),d=this.getType();if(!a)return[];if(d==CKEDITOR.SELECTION_TEXT)return a=new CKEDITOR.dom.range(this.root),
...
(function(){function a(a,b){for(var c,d;(a=a.getParent())&&!a.equals(b);)if(a.getAttribute("data-nostyle"))c=a;else if(!d){var e=a.getAttribute("contentEditable");"false"==e?c=a:"true"==e&&(d=1)}return c}function d(a,b,c,d){return(a.getPosition(b)|d)==d&&(!c.childRule||c.childRule(a))}function b(c){var e=c.document;if(c.collapsed)e=L(this,e),c.insertNode(e),c.moveToPosition(e,CKEDITOR.POSITION_BEFORE_END);else{var f=this.element,h=this._.definition,k,l=h.ignoreReadonly,q=l||h.includeReadonly;null==
...
c=a.createIterator();c.enforceRealBlocks=!0;c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,e;d=c.getNextParagraph();)this.checkElementRemovable(d)&&(d.is("pre")?((e=this._.enterMode==CKEDITOR.ENTER_BR?null:a.document.createElement(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))&&d.copyAttributes(e),q(d,e)):y.call(this,d));a.moveToBookmark(b)}function q(a,b){var c=!b;c&&(b=a.getDocument().createElement("div"),a.copyAttributes(b));var d=b&&b.is("pre"),e=a.is("pre"),g=!d&&e;if(d&&!e){e=b;(g=
...
r(a,e,E[a.getName()]);f&&(this._.definition.alwaysRemoveElement?m(a,1):!CKEDITOR.dtd.$block[a.getName()]||this._.enterMode==CKEDITOR.ENTER_BR&&!a.hasAttributes()?m(a):a.renameNode(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))}function F(a){for(var b=G(this),c=a.getElementsByTag(this.element),d,e=c.count();0<=--e;)d=c.getItem(e),d.isReadOnly()||y.call(this,d,!0);for(var f in b)if(f!=this.element)for(c=a.getElementsByTag(f),e=c.count()-1;0<=e;e--)d=c.getItem(e),d.isReadOnly()||r(d,b[f])}function r(a,
b,c){if(b=b&&b.attributes)for(var d=0;d<b.length;d++){var e=b[d][0],f;if(f=a.getAttribute(e)){var g=b[d][1];(null===g||g.test&&g.test(f)||"string"==typeof g&&f==g)&&a.removeAttribute(e)}}c||m(a)}function m(a,b){if(!a.hasAttributes()||b)if(CKEDITOR.dtd.$block[a.getName()]){var c=a.getPrevious(I),d=a.getNext(I);!c||c.type!=CKEDITOR.NODE_TEXT&&c.isBlockBoundary({br:1})||a.append("br",1);!d||d.type!=CKEDITOR.NODE_TEXT&&d.isBlockBoundary({br:1})||a.append("br");a.remove(!0)}else c=a.getFirst(),d=a.getLast(),
...
CKEDITOR.dom.document)return K.call(this,a.getSelection(),1);if(this.checkApplicable(a.elementPath(),a)){var b=this._.enterMode;b||(this._.enterMode=a.activeEnterMode);K.call(this,a.getSelection(),1,a);this._.enterMode=b}},applyToRange:function(a){this.applyToRange=this.type==CKEDITOR.STYLE_INLINE?b:this.type==CKEDITOR.STYLE_BLOCK?k:this.type==CKEDITOR.STYLE_OBJECT?e:null;return this.applyToRange(a)},removeFromRange:function(a){this.removeFromRange=this.type==CKEDITOR.STYLE_INLINE?c:this.type==CKEDITOR.STYLE_BLOCK?
l:this.type==CKEDITOR.STYLE_OBJECT?h:null;return this.removeFromRange(a)},applyToObject:function(a){v(a,this)},checkActive:function(a,b){switch(this.type){case CKEDITOR.STYLE_BLOCK:return this.checkElementRemovable(a.block||a.blockLimit,!0,b);case CKEDITOR.STYLE_OBJECT:case CKEDITOR.STYLE_INLINE:for(var c=a.elements,d=0,e;d<c.length;d++)if(e=c[d],this.type!=CKEDITOR.STYLE_INLINE||e!=a.block&&e!=a.blockLimit){if(this.type==CKEDITOR.STYLE_OBJECT){var f=e.getName();if(!("string"==typeof this.element?
...
CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE;b/=CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE;var d=c/CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE,g=Math.max(a,b,d),f=Math.min(a,b,d);c=g-f;var w=0;switch(g){case a:w=(b-d)/c%6;break;case b:w=(d-a)/c+2;break;case d:w=(a-b)/c+4}a=0===c?0:60*w;b=(g+f)/2;g=0;1!==b&&0!==b&&(g=c/(1-Math.abs(2*b-1)));a=Math.round(a);g=Math.round(100*g);b=Math.round(100*b);return[a,g,b]}},statics:{TYPE_RGB:1,TYPE_HSL:2,MAX_RGB_CHANNEL_VALUE:255,MAX_ALPHA_CHANNEL_VALUE:1,MAX_HUE_CHANNEL_VALUE:360,
...
(function(){var a={},d={},b;for(b in CKEDITOR.dtd.$blockLimit)b in CKEDITOR.dtd.$list||(a[b]=1);for(b in CKEDITOR.dtd.$block)b in CKEDITOR.dtd.$blockLimit||b in CKEDITOR.dtd.$empty||(d[b]=1);CKEDITOR.dom.elementPath=function(b,g){var e=null,h=null,k=[],l=b,q;g=g||b.getDocument().getBody();l||(l=g);do if(l.type==CKEDITOR.NODE_ELEMENT){k.push(l);if(!this.lastElement&&(this.lastElement=l,l.is(CKEDITOR.dtd.$object)||"false"==l.getAttribute("contenteditable")))continue;if(l.equals(g))break;if(!h&&(q=l.getName(),
"true"==l.getAttribute("contenteditable")?h=l:!e&&d[q]&&(e=l),a[q])){if(q=!e&&"div"==q){a:{q=l.getChildren();for(var f=0,w=q.count();f<w;f++){var B=q.getItem(f);if(B.type==CKEDITOR.NODE_ELEMENT&&CKEDITOR.dtd.$block[B.getName()]){q=!0;break a}}q=!1}q=!q}q?e=l:h=l}}while(l=l.getParent());h||(h=g);this.block=e;this.blockLimit=h;this.root=g;this.elements=k}})();
